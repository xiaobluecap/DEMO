...
def button(text, x, y, w, h, color, screen):
    ...
    font = pygame.font.Font('(文件中的字体路径)', 20)
...
def title(text, screen, scale, color=(255, 0, 0)):
    ...
    font = pygame.font.Font('（字体路径）', WIDTH//(len(text)*2))
...
def main():
    ...
    while running:
        ...
        for event in pygame.event.get():
            ...
            if mouse_pos[0] < like_pos_x+like_pos_width+5 and mouse_pos[0] > like_pos_x-5 and mouse_pos[1] < like_pos_y+like_pos_height+5 and mouse_pos[1] > like_pos_y-5:
